...
// console.log(dna.indexOf("T"), dna.indexOf("A"), dna.indexOf("C"), dna.indexOf("O"));
// console.log(dna.indexOf("CAT"));
// console.log(dna.slice(40, 43));
// dna = dna.toLowerCase();
// console.log(`${dna.slice(0)}`);
console.log(dna.indexOf("TAC"), dna.indexOf("CAT"));
console.log(`${dna.toLowerCase().slice(4, 7)}o ${dna.toLocaleLowerCase().slice(40, 43)}`);
/*LC Solution
